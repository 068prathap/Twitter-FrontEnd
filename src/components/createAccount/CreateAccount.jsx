...
import {navigationForward} from '../../utils/CreateAccount';
import { useNavigate } from 'react-router-dom';

export default function Create_account(props)
{
    ...
    return(
        <div className="sign_up">
            <div className="su">
                <div className="su_1">
                    <div className="su1">
                        <div className="su1_1" onClick={()=>navigate('/')}>
                ...
                <div ref={props.su_2} className="su_2">
                    <div className="su2">
                        ...
                        <div className="su2_5" onClick={()=>{navigationForward(props.nextLink,props.liveLink)}}>
                            <p>Create account</p>
                        </div>
                        <div className="su2_6">
                        ...
                        <div className="su2_7">
                            <p>Have an account already? <a onClick={()=>navigate('/login')}>Log in</a></p>
                        </div>
                    </div>
                </div>
            </div>
