            ...
            <div className='sideNavbar'>
                <div className='sideNavbarContent'>
                    ...
                    <div className='sideNavbarTabs'>
                        ...
                        <SideNavbarTab class={'sideNavbarMsgTab sideNavbarTab'} imgClass={'sideNavbarMsgTabImg sideNavbarTabImg'} imgRef={sideNavbarMsgTabImg} img={mailIcon} imgActive={mailIconActive} pClass={'sideNavbarMsgTabP sideNavbarTabP'} pRef={sideNavbarMsgTabP} pText={'Messages'} active={active} setActive={setActive} activeImg={activeImg} setActiveImg={setActiveImg} oldImg={oldImg} setOldImg={setOldImg} exploreTab={true}/>
                        ...
                        <SideNavbarTab class={'sideNavbarProfileTab sideNavbarTab'} imgClass={'sideNavbarProfileTabImg sideNavbarTabImg'} imgRef={sideNavbarProfileTabImg} img={profileIcon} imgActive={profileIconActive} pClass={'sideNavbarProfileTabP sideNavbarTabP'} pRef={sideNavbarProfileTabP} pText={'Profile'} active={active} setActive={setActive} activeImg={activeImg} setActiveImg={setActiveImg} oldImg={oldImg} setOldImg={setOldImg} navigate={store.profilePageUrl} exploreTab={true}/>
                        <SideNavbarTab class={'sideNavbarMoreTab sideNavbarTab'} imgClass={'sideNavbarMoreTabImg sideNavbarTabImg'} img={menuIcon} pClass={'sideNavbarMoreTabP sideNavbarTabP'} pRef={sideNavbarMoreTabP} pText={'More'} active={active} setActive={setActive}/>
                    </div>
